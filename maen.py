...
# Генерируем все перестановки из 5 букв (каждая по 1 разу)
for i in permutations("СОТКА", 5):
    s = ''.join(i) # Соединяем буквы в слово без пробелов

    # Проверяем: не начинается на 'С' И не содержит 'КА'
...
for n in range(1, 100):
    ...
    if r < 99:
        print(f"N = {n}, R = {r}") # выходной, халява бе бе бе